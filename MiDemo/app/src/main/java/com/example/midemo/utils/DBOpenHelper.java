    ...
    private void insertAccountData(SQLiteDatabase db) {
        ...
        try (Cursor cursor = db.rawQuery("SELECT COUNT(*) FROM " + TABLE_ACCOUNT, null)) {
            if (cursor.moveToFirst() && cursor.getInt(0) == 0) {
                // 插入模拟数据
                AccountBean[] mockAccounts = {
                        new AccountBean(0, "购物", R.mipmap.ic_gouwu_fs, "买衣服", 150.0f, "2024年06月08日 14:00", 2024, 6, 8, 0),
                        new AccountBean(0, "娱乐", R.mipmap.ic_yule_fs, "看电影", 60.0f, "2024年06月06日 20:30", 2024, 6, 6, 0),
                        new AccountBean(0, "零食", R.mipmap.ic_lingshi_fs, "买零食", 20.0f, "2024年06月05日 15:45", 2024, 6, 5, 0),
                        new AccountBean(0, "医疗", R.mipmap.ic_yiliao_fs, "买药", 35.0f, "2024年06月04日 11:00", 2024, 6, 4, 0),
                        new AccountBean(0, "交通", R.mipmap.ic_jiaotong_fs, "公交车费", 5.0f, "2024年06月03日 08:00", 2024, 6, 3, 0),
                        new AccountBean(0, "住宅", R.mipmap.ic_zhufang_fs, "交房租", 800.0f, "2024年06月01日 09:00", 2024, 6, 1, 0),
                        new AccountBean(0, "通讯", R.mipmap.ic_tongxun_fs, "手机费", 50.0f, "2024年05月29日 10:30", 2024, 5, 29, 0),
                        new AccountBean(0, "餐饮", R.mipmap.ic_canyin_fs, "外卖", 40.0f, "2024年05月28日 12:00", 2024, 5, 28, 0),
                        new AccountBean(0, "服饰", R.mipmap.ic_fushi_fs, "买鞋", 200.0f, "2024年05月27日 16:00", 2024, 5, 27, 0),
                        new AccountBean(0, "人情往来", R.mipmap.ic_renqingwanglai_fs, "送礼", 100.0f, "2024年05月26日 18:00", 2024, 5, 26, 0),
                        new AccountBean(0, "薪资", R.mipmap.in_xinzi_fs, "工资收入", 5000.0f, "2024年06月10日 09:00", 2024, 6, 10, 1),
                        new AccountBean(0, "奖金", R.mipmap.in_jiangjin_fs, "季度奖金", 1000.0f, "2024年06月09日 10:00", 2024, 6, 9, 1),
                        new AccountBean(0, "投资回报", R.mipmap.in_touzi_fs, "投资收益", 800.0f, "2024年06月08日 15:00", 2024, 6, 8, 1),
                        new AccountBean(0, "意外所得", R.mipmap.in_yiwai_fs, "彩票中奖", 200.0f, "2024年06月07日 17:00", 2024, 6, 7, 1),
                        new AccountBean(0, "利息收入", R.mipmap.in_lixifuji_fs, "银行利息", 50.0f, "2024年06月06日 09:00", 2024, 6, 6, 1),
                        new AccountBean(0, "收债", R.mipmap.in_shouzhai_fs, "朋友还钱", 300.0f, "2024年06月05日 14:00", 2024, 6, 5, 1),
                        new AccountBean(0, "借入", R.mipmap.in_jieru_fs, "借款", 1000.0f, "2024年06月04日 13:00", 2024, 6, 4, 1),
                        new AccountBean(0, "二手交易", R.mipmap.in_ershoushebei_fs, "卖旧书", 20.0f, "2024年06月03日 11:00", 2024, 6, 3, 1),
                        new AccountBean(0, "其他", R.mipmap.in_qt_fs, "其他收入", 100.0f, "2024年06月02日 16:00", 2024, 6, 2, 1),
                        new AccountBean(0, "薪资", R.mipmap.in_xinzi_fs, "工资收入", 4800.0f, "2024年05月31日 09:00", 2024, 5, 31, 1)
                };

                for (AccountBean account : mockAccounts) {
